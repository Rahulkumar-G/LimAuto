...
class CodeSampleAgent(BaseAgent):
    ...
    def _needs_code_samples(self, content: str) -> bool:
        ...
        technical_indicators = [
            'code', 'programming', 'implementation', 
    ...
    def _generate_chapter_code_samples(self, state: BookState, chapter_title: str, content: str):
        ...
        try:
            ...
            self.logger.error(f"Failed to generate code sample for {chapter_title}: {e}")
